...
pygame.display.set_caption('Mapa Espacial Roxo')
clock = pygame.time.Clock()
tile_size = 16
 
# --- imagens ---
# fundos 
bb = pygame.transform.scale(pygame.image.load('Space_Backgroundz.png').subsurface((100,   0, 100, 100)), (tile_size, tile_size))
bs = pygame.transform.scale(pygame.image.load('Space_Backgroundz.png').subsurface(( 50,  50, 100, 100)), (tile_size, tile_size))
bw = pygame.transform.scale(pygame.image.load('Space_Backgroundz.png').subsurface((  0, 100, 100, 100)), (tile_size, tile_size))
...
tiles_img = {
    'bb': bb,   # fundo roxo escuro
    'bs': bs,   # fundo com estrelas leves
    'bw': bw,   # roxo mais brilhante (nebulosa rosa)
    'a2': a2,   # asteroide
    'ps': ps,   # planeta pequeno
}
 
# mapa de fundo - cobre a tela inteira
mapa = [
