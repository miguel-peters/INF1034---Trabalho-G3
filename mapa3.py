...
pygame.display.set_caption('Mapa Espacial Laranja')
clock = pygame.time.Clock()
tile_size = 16
 
# --- imagens ---
#fundos
bb = pygame.transform.scale(pygame.image.load('Space_Background.png').subsurface((100,  50, 100, 100)), (tile_size, tile_size))
bs = pygame.transform.scale(pygame.image.load('Space_Background.png').subsurface((  0,   0, 100, 100)), (tile_size, tile_size))
bw = pygame.transform.scale(pygame.image.load('Space_Background.png').subsurface((  0, 100, 100, 100)), (tile_size, tile_size))
...
tiles_img = {
    'bb': bb,   # fundo laranja escuro
    'bs': bs,   # fundo com nebulosa leve
    'bw': bw,   # laranja mais brilhante
    'a2': a2,   # asteroide
...
while True:
    ...
    # camada 1 — fundo laranja de espaço
